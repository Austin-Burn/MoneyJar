...
pub fn create_who_in_what(wiw_user_id: String, wiw_event_id: String) -> Result<(), Error> {
...
pub fn wiw_get_users(wiw_event_id: String) -> Result<Vec<String>, Error> {
    let conn = &mut establish_connection();
...
pub fn wiw_get_events(wiw_user_id: String) -> Result<Vec<String>, Error> {
    let conn = &mut establish_connection();
...
pub fn delete_who_in_what(get_user_id: String, get_events_id: String) -> Result<(), Error> {
    let conn = &mut establish_connection();
